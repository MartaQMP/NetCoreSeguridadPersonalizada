...
namespace NetCoreSeguridadPersonalizada.Controllers
{
    public class ManagedController : Controller
    {
        ...
        public async Task<IActionResult> LogIn(string userName, string password)
        {
            ...
            {
                /* POR MEDIDAS DE SEGURIDAD, SE GENERA UNA COOKIE CIFRADA QUE ES PARA SABER
                 * SI EL USER SE HA VALIDADO EN ESTE EXPLORADOR O NO */
                ...
                await HttpContext.SignInAsync(
                    ...
                    userPrincipal, 
                    new AuthenticationProperties { ExpiresUtc = DateTime.Now.AddMinutes(10)}
                );
